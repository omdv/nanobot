    ...
    async def _process_message(self, msg: InboundMessage, session_key: str | None = None) -> OutboundMessage | None:
        ...
        while iteration < self.max_iterations:
            ...
            if response.has_tool_calls:
                ...
                # Strip thinking tags from final response unless configured to include
                if final_content and "<thinking>" in final_content and not self.thinking_config.include_in_response:
                    import re
